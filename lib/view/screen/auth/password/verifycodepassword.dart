import 'package:e_commerce_app/controller/auth/passwordcontroller/verifycodecontroller.dart';
...
class VerifyCodeResetPasswordScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    VerifyCodeImpController controller = Get.put(VerifyCodeImpController());
    return Scaffold(
      appBar: AppBar(
        title: Center(
          child: Text(
